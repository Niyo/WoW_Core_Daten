...
#define NEXT_PAGE               "-> [Naechste Seite]"
#define PREV_PAGE               "<- [Vorherige Seite]"
#define MAIN_MENU               "<= [Hauptmenue]"
...
bool GossipHello_npc_teleport(Player *player, Creature *creature)
{
    ...
    if(player->isInCombat())
    {
        ...
        creature->MonsterWhisper("Sie sind im Kampf verwickelt. Kommen Sie spaeter nochmals vorbei!", player->GetGUID());
        return true;
    }
