...
<?php
// MySQL settings
$WoWHostname = "127.0.0.1"; // MySQL server address
$WoWUsername = "akitos"; // MySQL username
$WoWPassword = "29199pinendgegner"; // MySQL password
$CharacterDatabase = 'oregon_char'; // TC characters database
$RealmDatabase = 'oregon_realmd'; // TC relamd database
$WorldDatabase = 'oregon_world'; // TC world database
...
$gamebuild_query = mysql_query("SELECT `realmbuilds` FROM $RealmDatabase.`realmlist`", $world_db)or die(mysql_error());
...
$total_uptime_query = mysql_query("SELECT (SELECT SUM(uptime) FROM $WorldDatabase.`uptime`)as total_uptime", $realm_db)or die(mysql_error()); 
