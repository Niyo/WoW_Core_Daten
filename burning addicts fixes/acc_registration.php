...
$user = "acc_register";
// Password.
$pass = "qZRz4XR3u5ws28Sh";
// Site title.
$title = "Account Registration";
$title2 = "Burning-Addicts";
// End config.
...
Email:
<br /><input name="email" type="text" maxlength="50" /><br />
...
if (!empty($_POST)) {
        if ((empty($_POST["username"]))||(empty($_POST["password"]))||(empty($_POST["email"])) ) {
                ...
                $register_sql = "insert into " . mysql_real_escape_string($r_db) . ".account (username, sha_pass_hash, email, expansion) values (upper('" . $username . "'),'" . $sha_pass_hash . "','" . $email . "','1')";
