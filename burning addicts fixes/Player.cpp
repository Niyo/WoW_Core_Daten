...
void Player::CheckAreaExploreAndOutdoor()
{
    ...
    //remove flight mount if you enter garadar and telaar
    if (GetAreaId() == 3613 || GetAreaId() == 3626)
    {
        if (HasAuraType(SPELL_AURA_MOD_FLIGHT_SPEED_MOUNTED) || HasAuraType(SPELL_AURA_FLY))
        {
